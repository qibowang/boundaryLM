...
public class MiddleLeftJoinRightDriver {
	public static void main(String[] args) {
		...
		try {
			...
			Job joinJob = Job.getInstance(conf, "middle left join right job");
			System.out.println(joinJob.getJobName()+" is running!");
			
			joinJob.setJarByClass(MiddleLeftJoinRightDriver.class);
			joinJob.setMapperClass(MiddleLeftJoinRightMapper.class);
			joinJob.setReducerClass(MiddleLeftJoinRightReducer.class);
